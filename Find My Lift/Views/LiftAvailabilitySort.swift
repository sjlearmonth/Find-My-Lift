...
protocol LiftAvailabilitySortDelegate: class {
    func executeDynamicSearch(query: String, type: radioButtonStates)
}

class LiftAvailabilitySort: UIView {
    ...
    private let driverSortTitleLabel: UILabel = {
        ...
        label.font = UIFont(name: LABEL_FONT_DEMIBOLD, size: 18)
    ...
    private lazy var driverSortTextField: UITextField = {
        ...
        tf.font = UIFont(name: LABEL_FONT_DEMIBOLD, size: 15)
    ...
    weak var delegate: LiftAvailabilitySortDelegate?
...
extension LiftAvailabilitySort: UITextFieldDelegate {
