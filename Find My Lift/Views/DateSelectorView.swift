...
class DateSelectorView: UIView {
    ...
    @objc func handleSetClicked() {
        delegate?.readDateSelected(date: dateSelector.date)
        self.removeFromSuperview()
    }
    ...
    private func configureUI() {
        ...
        dateSelector.centerY(inView: self)
        dateSelector.centerX(inView: self)
        
        self.addSubview(cancelButton)
        cancelButton.anchor(left: leftAnchor, bottom: bottomAnchor, paddingLeft: 16, paddingBottom: 0)
        
        self.addSubview(setButton)
        setButton.anchor(bottom: bottomAnchor, right: rightAnchor, paddingBottom: 0, paddingRight: 8)
