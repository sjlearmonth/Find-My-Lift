...
protocol MatchedLiftRequestsSortDelegate: class {
    func executeDynamicSearch(query: String, type: radioButtonStates)
}

class MacthedLiftRequestsSort: UIView {
    ...
    weak var delegate: MatchedLiftRequestsSortDelegate?
...
extension MacthedLiftRequestsSort: UITextFieldDelegate {
