...
class LiftOfferReviewVC: UIViewController {
    ...
    private func configureTableView() {
        ...
        tableView.register(LORCell.self, forCellReuseIdentifier: cellID)
    }
...
extension LiftOfferReviewVC: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: cellID) as! LORCell
