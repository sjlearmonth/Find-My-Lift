...
class LiftAvailabilityVC: UIViewController {
    ...
    private lazy var sortView = LiftAvailabilitySort()
...
extension LiftAvailabilityVC: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let headerView = LiftAvailabilityHeader(frame: CGRect(x: 0, y: 0, width: tableView.frame.width, height: 120.0))
...
extension LiftAvailabilityVC: LiftAvailabilitySortDelegate {
