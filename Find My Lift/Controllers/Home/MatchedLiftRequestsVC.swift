...
class MatchedLiftRequestsVC: UIViewController {
    ...
    private lazy var tableView: UITableView = {
        ...
        tableView.register(MatchedLiftRequestsCell.self, forCellReuseIdentifier: cellID)
    ...
    private lazy var sortView = MacthedLiftRequestsSort()
...
extension MatchedLiftRequestsVC : UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let headerView = MatchedLiftRequestsHeader(frame: CGRect(x: 0, y: 0, width: tableView.frame.width, height: 60.0))
        return headerView
    }
...
extension MatchedLiftRequestsVC : UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: cellID) as! MatchedLiftRequestsCell
        if listSearchResults == false {
...
extension MatchedLiftRequestsVC: MatchedLiftRequestsSortDelegate {
